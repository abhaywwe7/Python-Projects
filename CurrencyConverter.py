...
class CurrencyConverter():
    ...
    def convert(self, from_currency, to_currency, amount):
        ...
        amount = round(amount * self.currencies[to_currency], 5)
        return amount
...
class App_UI(tk.Tk):
    ...
    def __init__(self, converter):
        tk.Tk.__init__(self)
        self.title = "ABHAY'S Currency Converter"
        self.currency_converter = converter

        self.configure(background = "white smoke")
        self.geometry("500x200")

        # Label
        self.intro_label = Label(self, text="Welcome to Real Time Currency Convertor", fg="blue", relief=tk.RAISED,anchor='center',
                                 borderwidth=4)
        self.intro_label.config(font=("Roboto", 15, "bold"))
        ...
        self.convert_button.config(font=("roboto", 10, "bold"))
